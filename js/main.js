...
"use strict";
    ...
    if(window.screen.availWidth<580){
        $(".education").parent().append($(".personality"));
    }
    $('.end-lmpixels-scroll-to-top').click(function () {
        $('body,html').animate({
            scrollTop: 0
        }, 400);
        return false;
    ...
    //         $(".ajax-page-prev-next").addClass("hide");
    //     }else{
    //         $(".ajax-page-prev-next").removeClass("hide");
    //     }
    // };
    ...
    $(window)
        ...
        .on('resize', function(){
            if(window.screen.availWidth<580){
                ...
                if($(".personality").length===1){
                    $(".experience").parent().append($(".personality"));
                }
            }
        })
